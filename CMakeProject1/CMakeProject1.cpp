...
int main() {
    /*
      Mat image = imread("C:/Users/danaa/Downloads/CMakeOpenCVProject1/input/image_2.jpg");
      imshow("image", image);
      waitKey(1000);
        */
    std::vector<std::string> class_names;
    ifstream ifs(string("C:/Users/danaa/Downloads/CMakeProject1/resources/object_detection_classes_coco.txt").c_str());
    string line;
    while (getline(ifs, line))
    {
        class_names.push_back(line);
    }
    auto model = readNet("C:/Users/danaa/Downloads/CMakeProject1/resources/frozen_inference_graph.pb",
        "C:/Users/danaa/Downloads/CMakeProject1/resources/ssd_mobilenet_v2_coco_2018_03_29.pbtxt.txt",
        "TensorFlow");
    ...
    Mat image = imread("C:/Users/danaa/Downloads/CMakeProject1/resources/image4.jpg");
